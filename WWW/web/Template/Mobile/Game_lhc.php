...
<section class="" id="gamepage">
  <div class="mobileGameTop">
	...
	<div class="open_containers g_Time_Section">
        <!--彩种开奖倒计时-->
        <div class="cz_daojishi" style="width: 31%;height: 90px;">
        ...
        <div class="cz_openNumb">
            ...
            <div class="open_number">
                ...
                <ol id="ssc_winning_sum">
									<li class="lhc_winning_sum_gif" style="width:22px;height:22px;margin: 0 2px;font-size:10px;line-height:20px;font-weight:normal;" way-data="showExpect.openCode1">
									</li>
									<li class="lhc_winning_sum_gif" style="width:22px;height:22px;margin: 0 2px;font-size:10px;line-height:20px;font-weight:normal;" way-data="showExpect.openCode2"></li>
									<li class="lhc_winning_sum_gif" style="width:22px;height:22px;margin: 0 2px;font-size:10px;line-height:20px;font-weight:normal;" way-data="showExpect.openCode3"></li>
									<li class="lhc_winning_sum_gif" style="width:22px;height:22px;margin: 0 2px;font-size:10px;line-height:20px;font-weight:normal;" way-data="showExpect.openCode4"></li>
									<li class="lhc_winning_sum_gif" style="width:22px;height:22px;margin: 0 2px;font-size:10px;line-height:20px;font-weight:normal;" way-data="showExpect.openCode5"></li>
									<li class="lhc_winning_sum_gif" style="width:22px;height:22px;margin: 0 2px;font-size:10px;line-height:20px;font-weight:normal;" way-data="showExpect.openCode6"></li>
									<li style="color: #333;border-radius:0;box-shadow:none;width: 10px;margin: 0;height: 30px;background: none;font-size: 14px;">+</li>
									<li class="lhc_winning_sum_gif" style="width:22px;height:22px;margin: 0 2px;font-size:10px;line-height:20px;font-weight:normal;" way-data="showExpect.openCode7"></li>
								</ol>
								<ol class="lhc_sxTextUl">
									<li class="lhcsxText"></li>
									<li class="lhcsxText"></li>
									<li class="lhcsxText"></li>
									<li class="lhcsxText"></li>
									<li class="lhcsxText"></li>
									<li class="lhcsxText"></li>
									<li style="width: 12px;margin: 0 1px;"></li>
									<li class="lhcsxText"></li>
								</ol>
            </div>
