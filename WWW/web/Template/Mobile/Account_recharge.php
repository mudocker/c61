		...
		<form action="" method="post" id="formrecharge" class="am-form">
			<ul class="bank_form_list">
				...
				<li class="am-cf">
					...
					<div class="am-fr bank_right_input">
						<input type="text" value="{$bankname}" class="copy_txt" disabled="disabled"><span class="copu_btn">复制</span>
					</div>
				</li>
				<li class="am-cf">
					<span class="bank_form_left am-fl">收款账号</span>
					<div class="am-fr bank_right_input">
						<input type="text" value="{$bankcode}" class="copy_txt" disabled="disabled"><span class="copu_btn">复制</span>
					</div>
				</li>
				<li class="am-cf">
					<span class="bank_form_left am-fl">开户支行</span>
					<div class="am-fr bank_right_input">
						<input type="text" value="{$payinfo.ftitle}" class="copy_txt" disabled="disabled"><span class="copu_btn">复制</span>
					</div>
				</li>
				<li class="am-cf">
