 ...
 */
	...
	$pfxFile = dirname(__FILE__)."/cert/210001440013076.pfx";
	// 私钥密码
	$passwd = "merchtest";
	// Mo宝支付系统公钥
	$pubFile = dirname(__FILE__)."/cert/epay.cer";
	// Mo宝支付系统网关地址（正式环境）
	...
	// Mo宝支付分配给商户的账号
	$merchant_acc = "210003510003000";
	// 商户通知地址（请根据自己的部署情况设置下面的路径）
	$merchant_notify_url = "http://192.168.31.42/mbpe/callback.php";
	
	// 银行代码列表
	$bankcode['MOBOACC'] = "";// 此选择将跳转收银台
	// 工行
	$bankcode['ICBC'] = "ICBC";
	// 农行 
	$bankcode['ABC'] = "ABC";
