...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" deleteall-url="{:U('deleteall')}" title="删除" class="btn btn-danger-outline radius">删除</a>&nbsp;&nbsp;<a href="javascript:;" listorder-url="{:U('listorder')}" title="排序" class="btn btn-danger-outline radius">排序</a></span> <span class="r">共有数据：<strong>{:count($olist)}</strong> 条</span> </div>
    </form>
	</div>
</div>
