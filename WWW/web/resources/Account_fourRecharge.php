		...
		<div class="pull-right vip_info_pan">
			...
			<div class="vip_info_content zfb_main">
				<ul class="tab clearfix recharge_main_tab">
					...
					<li><a href="{:U('Account/quickRecharge')}">网银</a></li>
					<li style="width:120px;"><a href="{:U('Account/zfbRecharge')}" style="width:100px;">支付宝扫码充值</a></li>
				<!--	<li class="active" style="width:120px;"><a href="{:U('Account/fourRecharge')}" style="width:100px;">四合一在线充值</a></li>-->
					 <li><a href="{:U('Account/wxRecharge')}">微信扫码支付</a></li> 
				</ul>
