$(function () {
  ...
  function tabGameInit(){
    ...
    gameSwitch($('.bet_filter_box'),pl3_3x_title,pl3_3x_arr);
  ...
  $('.g_Number_Section').on('click','.selectNumbers a',function (){
    if(_thisPlayid == 'pl3_3x_zuxcsbd' || _thisPlayid == 'zuxzsbd' || _thisPlayid == 'pl3zuxbd' ||  _thisPlayid == 'pl3q2zxbd' || _thisPlayid == 'pl3h2zxbd'){
  ...
  $('.addtobetbtn').on('click',function (){
    ...
    if(zhushus.length >= 1){
      ...
      yBetting.each(function (i) {
        ...
        if(_thisPlayid == 'dxdsh2' || _thisPlayid == 'dxdsh2' || _thisPlayid == 'dxdsqs' || _thisPlayid == 'dxdshs'){
  ...
  $(document).on('click','#j_play_select li',function () {
    ...
    switch(this_attr){
      ...
      case 'pl3_q2':
        $('#bet_filter').remove();
        gameSwitch($('.bet_filter_box'),pl3_q2_title,pl3_qe_arr);
      ...
      case 'pl3_h2':
        $('#bet_filter').remove();
        gameSwitch($('.bet_filter_box'),pl3_q2_title,pl3_he_arr);
      ...
      case 'pl3_1x':
        $('#bet_filter').remove();
        gameSwitch($('.bet_filter_box'),pl3_1x_title,pl3_1x_arr);
      ...
      case 'pl3_dsds':
        $('#bet_filter').remove();
        gameSwitch($('.bet_filter_box'),ssc_dsds_title,pl3_dsds_arr);
        _thisPlayid = 'dxdsq2';
        rates = yrates[_thisPlayid];
        $('.play_select_prompt').find('span[way-data="tabDoc"]')
          .html('从百位、十位中的“大、小、单、双”中至少各选一个组成一注，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
