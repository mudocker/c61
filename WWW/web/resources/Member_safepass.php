...
<div class="wapper ">
	<div class="w1000">
        ...
        <div class="content bg_wite update_pass" >
            <div class="h30"></div>
            <div class="table_box">
            	<form class="ruivalidate_form_class update_form " action="" method="post" id="form1" style="padding:30px 292px;">
                    <dl>
                        <dt>原资金密码：</dt>
                        <dd><input  type="password" class="text_in" name="oldpassword" errormsg="资金密码范围在6~16位之间！" nullmsg="请设置原资金密码！" datatype="s6-16"/><em class="Validform_checktip">未设置过资金密码则是登陆密码</em></dd>
                    </dl>
                    <dl>
                        <dt>填写资金密码：</dt>
                        <dd><input  type="password" class="text_in" name="pa1" errormsg="资金密码范围在6~16位之间！" nullmsg="请设置新资金密码！" datatype="s6-16"/><em class="Validform_checktip"></em></dd>
                    </dl>
                    <dl>
                        <dt>确认资金密码：</dt>
                        <dd>
