		...
		<div class="pull-right vip_info_pan">
			...
			<div class="vip_info_content betRecord_main">
				<div class="betRecord_top">
					<span>平台帐户余额：<em>{$balance}元</em></span>
					<span>AG金额：<em ><i class="ag">{$agBalance}</i>元</em></span>
					<span>BBIN金额：<em ><i class="bbin">{$bbBalance}</i>元</em></span>
				</div>
				<div class="betRecord_tab clearfix" style="height:auto">
					...
					<div class="category >
						...
						<div class="form-group">
							...
							<input type ="text" name="amout" id="amout" onkeyup="this.value=this.value.replace(/[^\d]/g,'');"
							style="border-radius: 4px;border: 1px solid #cccccc;padding: 0px 5px;width: 280px;height: 36px;line-height:36px;background-color: #fff;color: #A9A9A9;font-size: 12px;"/>
						</div>
					</div>
					<div class="category >
