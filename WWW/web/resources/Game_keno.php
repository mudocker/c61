	...
	<div class="open_containers g_Time_Section">
        ...
        <div class="cz_logo">
            ...
            <a href="javascript:void(0)" >
                <i class="icon-kuaile8 iconfont common_lottery_icon" style="color:#fc5826;"></i>
            </a>
        </div>
        <!--彩种logo-->
        <!--彩种开奖倒计时-->
        ...
        <div class="cz_openNumb">
            ...
            <div class="open_number">
                ...
                <ol id="ssc_winning_sum" style="padding: 0 7px;">
					<li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode1"></li>
                    <li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode2"></li>
                    <li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode3"></li>
                    <li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode4"></li>
                    <li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode5"></li>
					<li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode6"></li>
                    <li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode7"></li>
                    <li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode8"></li>
                    <li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode9"></li>
                    <li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode10"></li>
					<li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode11"></li>
                    <li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode12"></li>
                    <li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode13"></li>
                    <li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode14"></li>
                    <li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode15"></li>
					<li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode16"></li>
                    <li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode17"></li>
                    <li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode18"></li>
                    <li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode19"></li>
                    <li class="kl8_winning_sum_gif" style="width:25px;height:31px;margin: 0 1px;font-size:10px;line-height:31px;" way-data="showExpect.openCode20"></li>
				</ol>
            </div>
