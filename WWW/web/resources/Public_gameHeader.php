...
<header class="header" style="background:#000;height:40px;line-height:40px;">
            ...
            <div class="pull-right user_login_info">
                <ul>
                    <li class="user_login_info1">
                        <a  href="{:U('Member/index')}" style="color:#fff;" class="user_header" data-html="true" class="user_header" data-container="body" data-toggle="popover" data-placement="bottom"data-content='<div class="ceng"><div class="media"><div class="media-left"><a href="{:U('Member/index')}"><img src="__ROOT__{$userinfo.face}" alt="" class="media-boject img-circle"></a><p>{$userinfo.username}</p></div><div class="media-body" style="padding-bottom:10px;">
    ...
    <li class="user_login_info2">
        <a href="{:U('Member/index')}" class="my_account" style="color:#fff;">
            我的账户
            <i class="iconfont">&#xe6a1;</i>
        </a>
    ...
    <li class="user_login_info4">
        <a href="{:U('Account/quickRecharge')}" style="color:#fff;">充值</a>
    </li>
    ...
    <div class="pull-right user_login_info ">
        ...
        <a href="{:U('Agent/index')}" style="color:#fff;">代理中心</a>
    </div>
    </notempty>
    </div>
</header>
