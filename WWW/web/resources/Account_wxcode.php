...
<p class="text-center h4">请使用微信扫描下面的二维支付码</p>
...
<p class="text-center" style="color:red;font-size: 20px;margin-top: 40px;font-weight: bold;">温馨提示:必须将“附言码”粘贴或正确输入微信“附言”栏中，否则充值将无法到账。</p>
