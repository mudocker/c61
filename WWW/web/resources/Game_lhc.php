	...
	<div class="open_containers g_Time_Section">
        ...
        <div class="cz_logo">
            ...
            <a href="javascript:void(0)" >
                <i class="icon--liuhecai iconfont common_lottery_icon" style="color:#07b39e;"></i>
            </a>
        </div>
        <!--彩种logo-->
        <!--彩种开奖倒计时-->
        ...
        <div class="cz_openNumb">
            ...
            <div class="open_number">
                ...
                <ol id="ssc_winning_sum">
					<li class="lhc_winning_sum_gif" style="width:30px;height:30px;margin: 0 2px;font-size:14px;line-height:30px;" way-data="showExpect.openCode1">
					</li>
                    <li class="lhc_winning_sum_gif" style="width:30px;height:30px;margin: 0 2px;font-size:14px;line-height:30px;" way-data="showExpect.openCode2"></li>
                    <li class="lhc_winning_sum_gif" style="width:30px;height:30px;margin: 0 2px;font-size:14px;line-height:30px;" way-data="showExpect.openCode3"></li>
					<li class="lhc_winning_sum_gif" style="width:30px;height:30px;margin: 0 2px;font-size:14px;line-height:30px;" way-data="showExpect.openCode4"></li>
					<li class="lhc_winning_sum_gif" style="width:30px;height:30px;margin: 0 2px;font-size:14px;line-height:30px;" way-data="showExpect.openCode5"></li>
					<li class="lhc_winning_sum_gif" style="width:30px;height:30px;margin: 0 2px;font-size:14px;line-height:30px;" way-data="showExpect.openCode6"></li>
					<li style="color: #333;border-radius:0;box-shadow:none;width: 12px;height: 30px;background: none;font-size: 14px;">+</li>
					<li class="lhc_winning_sum_gif" style="width:30px;height:30px;margin: 0 2px;font-size:14px;line-height:30px;" way-data="showExpect.openCode7"></li>
				</ol>
				<ol class="lhc_sxTextUl">
					...
					<li class="lhcsxText"></li>
					<li class="lhcsxText"></li>
					<li style="width: 12px;margin: 0 5px;"></li>
					<li class="lhcsxText"></li>
				</ol>
            </div>
