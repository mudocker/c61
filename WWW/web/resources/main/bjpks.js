...
var lotterytimes = function(lotteryname){
	...
	$.post(url, {'lotteryname':lotteryname,'cptype':'pk10'}, function(data) {
		if(data.sign==true){
			lottery = data.data;
...
var lotteryopencodes = function(lotteryname){
	...
	$.post(url, {'lotteryname':lotteryname}, function(data) {
        ...
        var yopentime = yopentimes_arr[1];
				html += '<tr><td width="130">'+openinfo.expect+'</td><td width="46" class="c_red fb" style="padding:5px;position:relative;"><div style="width:108px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;padding-right:20px;">'+openinfo.opencode+'</div><a href="javascript:void(0);" class="opencode_info">详情</a></td><td width="40" class="c_blue fb" style="padding:5px;">'+yopentime+'</td></tr>';
            ...
            if (msg.sign == true) {
                if (msg.data.opencode.length > 0) {
                    ...
                    if (lastExpect == openexpect) {
                        ...
                        html += '" ><div style="width:108px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;padding-right:20px;">';
...
function setLotterNumber(_index,_nums) {
  ...
  if(_nums == 'gif'){
    openLotteryList.eq(_index).attr('class','bjpks_winning_sum_gif');
