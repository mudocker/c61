...
var lotterytimes = function(lotteryname){
	...
	$.post(url, {'lotteryname':lotteryname,'cptype':'keno'}, function(data) {
		if(data.sign==true){
			lottery = data.data;
...
var lotteryopencodes = function(lotteryname){
	...
	$.post(url, {'lotteryname':lotteryname}, function(data) {
        ...
        var yopentime = yopentimes_arr[1];
				html += '<tr><td width="130">'+openinfo.expect+'</td><td width="46" class="c_red fb" style="padding:5px;position:relative;"><div style="width:65px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;padding-right:20px;">'+openinfo.opencode+'</div><a href="javascript:void(0);" class="opencode_info">详情</a></td><td width="40" class="c_blue fb" style="padding:5px;">'+yopentime+'</td></tr>';
            ...
            if (msg.sign == true) {
                if (msg.data.opencode.length > 0) {
                    ...
                    if (lastExpect == openexpect) {
                        ...
                        var yopentimes_arr = yopentimes.split(' ');
                        var yopentime = yopentimes_arr[1];
                        var html = '<tr><td class="lsqh">' + openexpect + '</td><td style="padding:5px;position:relative;" class="c_red fb';
                        html += '" ><div style="width:65px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;padding-right:20px;">';
                        ...
                        html += '</div><a href="javascript:void(0);" class="opencode_info">详情</a></td><td class="c_blue fb" style="padding:5px;">'+yopentime+'</td></tr>';
...
function openLottery(ball, maxnum) {
	if (T20) {
		clearInterval(T20);
		way.set("showExpect.openCode20", " ");
	}
	if (T19) {
		clearInterval(T19);
		way.set("showExpect.openCode19", " ");
	}
	if (T18) {
		clearInterval(T18);
		way.set("showExpect.openCode18", " ");
	}
	if (T17) {
		clearInterval(T17);
		way.set("showExpect.openCode17", " ");
	}
	if (T16) {
		clearInterval(T16);
		way.set("showExpect.openCode16", " ");
	}
	if (T15) {
		clearInterval(T15);
		way.set("showExpect.openCode15", " ");
	}
	if (T14) {
		clearInterval(T14);
		way.set("showExpect.openCode14", " ");
	}
	if (T13) {
		clearInterval(T13);
		way.set("showExpect.openCode13", " ");
	}
	if (T12) {
		clearInterval(T12);
		way.set("showExpect.openCode12", " ");
	}
	if (T11) {
		clearInterval(T11);
		way.set("showExpect.openCode11", " ");
	}
	if (T10) {
		clearInterval(T10);
...
function Lottery(num, maxnum) {
	if (num >= 20) {
		T20 = window.setInterval(function() {
			openLottery20(maxnum);
		}, 50);
	}
	if (num >= 19) {
		T19 = window.setInterval(function() {
			openLottery19(maxnum);
		}, 50);
	}
	if (num >= 18) {
		T18 = window.setInterval(function() {
			openLottery18(maxnum);
		}, 50);
	}
	if (num >= 17) {
		T17 = window.setInterval(function() {
			openLottery17(maxnum);
		}, 50);
	}
	if (num >= 16) {
		T16 = window.setInterval(function() {
			openLottery16(maxnum);
		}, 50);
	}
	if (num >= 15) {
		T15 = window.setInterval(function() {
			openLottery15(maxnum);
		}, 50);
	}
	if (num >= 14) {
		T14 = window.setInterval(function() {
			openLottery14(maxnum);
		}, 50);
	}
	if (num >= 13) {
		T13 = window.setInterval(function() {
			openLottery13(maxnum);
		}, 50);
	}
	if (num >= 12) {
		T12 = window.setInterval(function() {
			openLottery12(maxnum);
		}, 50);
	}
	if (num >= 11) {
		T11 = window.setInterval(function() {
			openLottery11(maxnum);
		}, 50);
	}
	if (num >= 10) {
...
function openLottery11(maxnum) {
	way.set("showExpect.openCode11", Math
			.round(Math.random() * (maxnum - 1) + 1));
}
function openLottery12(maxnum) {
	way.set("showExpect.openCode12", Math
			.round(Math.random() * (maxnum - 1) + 1));
}

function openLottery13(maxnum) {
	way.set("showExpect.openCode13", Math
			.round(Math.random() * (maxnum - 1) + 1));
}

function openLottery14(maxnum) {
	way.set("showExpect.openCode14", Math
			.round(Math.random() * (maxnum - 1) + 1));
}
function openLottery15(maxnum) {
	way.set("showExpect.openCode15", Math
			.round(Math.random() * (maxnum - 1) + 1));
}
function openLottery16(maxnum) {
	way.set("showExpect.openCode16", Math.round(Math.random() * (maxnum - 1) + 1));
}
function openLottery17(maxnum) {
	way.set("showExpect.openCode17", Math
			.round(Math.random() * (maxnum - 1) + 1));
}
function openLottery18(maxnum) {
	way.set("showExpect.openCode18", Math
			.round(Math.random() * (maxnum - 1) + 1));
}

function openLottery19(maxnum) {
	way.set("showExpect.openCode19", Math
			.round(Math.random() * (maxnum - 1) + 1));
}

function openLottery20(maxnum) {
	way.set("showExpect.openCode20", Math
			.round(Math.random() * (maxnum - 1) + 1));
}
...
function stopLottery(codes) {
	...
	if (nums.length >= 20) {
		setTimeout(function() {
			clearInterval(T20);
			setLotterNumber(19,nums[19]);
			way.set("showExpect.openCode20", nums[19] + "");
//			if(nums.length==10){
//				showLottery();
//			}
		}, 4000);
	...
	if (nums.length >= 19) {
		setTimeout(function() {
			clearInterval(T19);
			setLotterNumber(18,nums[18]);
			way.set("showExpect.openCode19", nums[18] + "");
//			if(nums.length==9){
//				showLottery();
//			}
		}, 4000);
	...
	if (nums.length >= 18) {
		setTimeout(function() {
			clearInterval(T18);
			setLotterNumber(17,nums[17]);
			way.set("showExpect.openCode18", nums[17] + "");
//			if(nums.length==8){
//				showLottery();
//			}
		}, 4000);
	...
	if (nums.length >= 17) {
		setTimeout(function() {
			clearInterval(T17);
			setLotterNumber(16,nums[16]);
			way.set("showExpect.openCode17", nums[16] + "");
//			if(nums.length==7){
//				showLottery();
//			}
		}, 3500);
	...
	if (nums.length >= 16) {
		setTimeout(function() {
			clearInterval(T16);
			setLotterNumber(15,nums[15]);
			way.set("showExpect.openCode16", nums[15] + "");
//			if(nums.length==6){
//				showLottery();
//			}
		}, 3000);
	...
	if (nums.length >= 15) {
		setTimeout(function() {
			clearInterval(T15);
      setLotterNumber(14,nums[14]);
			way.set("showExpect.openCode15", nums[14] + "");
			// if(nums.length==5){
			// 	showLottery();
			// }
		}, 2500);
	...
	if (nums.length >= 14) {
		setTimeout(function() {
			clearInterval(T14);
      setLotterNumber(13,nums[13]);
			way.set("showExpect.openCode14", nums[13] + "");
//			if(nums.length==4){
//				showLottery();
//			}
		}, 2000);
	...
	if (nums.length >= 13) {
		setTimeout(function() {
			...
			clearInterval(T13);
      setLotterNumber(12,nums[12]);
			way.set("showExpect.openCode13", nums[12] + "");
//			if(nums.length==3){
//				showLottery();
//			}
		}, 1500);
	...
	if (nums.length >= 12) {
		setTimeout(function() {
			var openLotteryList = $('#ssc_winning_sum').find('li');
			clearInterval(T12);
      setLotterNumber(11,nums[11]);
			way.set("showExpect.openCode12", nums[11] + "");
//			if(nums.length==2){
//				showLottery();
//			}
		}, 1000);
	...
	if (nums.length >= 11) {
		setTimeout(function() {
			clearInterval(T11);
      setLotterNumber(10,nums[10]);
			way.set("showExpect.openCode11", nums[10] + "");
//			if(nums.length==1){
//				showLottery();
//			}
		}, 200);
...
function setLotterNumber(_index,_nums) {
  ...
  if(_nums == 'gif'){
    openLotteryList.eq(_index).attr('class','kl8_winning_sum_gif');
