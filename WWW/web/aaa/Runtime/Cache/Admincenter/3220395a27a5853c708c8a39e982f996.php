	...
	<form action="" method="post" class="form form-horizontal validate-form" id="AjaxPostForm">
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($info["bankname"]); ?>" placeholder="所属银行" name="bankname">
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($info["bankbranch"]); ?>" placeholder="开户网点" name="bankbranch">
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($info["sheng"]); ?>" placeholder="开户省份" name="sheng">
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($info["city"]); ?>" placeholder="开户城市" name="city">
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($info["banknumber"]); ?>" placeholder="banknumber" name="banknumber">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="isdefault" type="radio" id="isdefault-1" value="1" <?php if($info['isdefault'] == 1): ?>checked<?php endif; ?>>
					<label for="isdefault-1">默认</label>
			  </div>
				<div class="radio-box">
					<input type="radio" id="isdefault-0" name="isdefault" value="0" <?php if($info['isdefault'] == 0): ?>checked<?php endif; ?>>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input <?php if($info['state'] == 0): ?>checked<?php endif; ?> name="state" type="radio" id="state-0" value="0">
					<label for="state-0">审核中</label>
				</div>
				<div class="radio-box">
					<input <?php if($info['state'] == 1): ?>checked<?php endif; ?> name="state" type="radio" id="state-1" value="1">
					<label for="state-1">已审</label>
				</div>
				<div class="radio-box">
				  <input type="radio" id="state-2" name="state" value="2" <?php if($info['state'] == 2): ?>checked<?php endif; ?>>
