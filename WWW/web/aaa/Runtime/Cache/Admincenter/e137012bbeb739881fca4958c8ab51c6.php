...
<div class="page-container">
	<form method="get" action="<?php echo U('bbtzrecord');?>" class="text-c">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                <td><?php echo ($vo["bbId"]); ?></td>
                <td><?php echo ($vo["UserName"]); ?></u></td>
                 <td><?php echo ($vo["WagersID"]); ?></td>
                <td><?php echo ($vo["SerialID"]); ?></td>
				<td><?php echo ($vo["RoundNo"]); ?></td>
				<td><?php echo ($vo["WagersDate"]); ?></td>
                <td><?php echo ($vo["GameType"]); ?></td>
				   <td><?php echo ($vo["GameCode"]); ?></td>
                <td><?php echo ($vo["WagerDetail"]); ?></td>
				<td><?php echo ($vo["Result"]); ?></td>
				<td><?php echo ($vo["BetAmount"]); ?></td>

                <td><?php echo ($vo["Commissionable"]); ?></td>
				<td><?php echo ($vo["Payoff"]); ?></td>
				<td><?php echo ($vo["ExchangeRate"]); ?></td>
