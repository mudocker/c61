	...
	<form action="" method="post" class="form form-horizontal validate-form" id="AjaxPostForm">
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($info["groupname"]); ?>" placeholder="会员组名称" name="groupname">
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($info["touhan"]); ?>" placeholder="touhan" name="touhan">
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($info["fanshui"]); ?>" placeholder="fanshui" name="fanshui">
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($info["bigmaxtouzhu"]); ?>" placeholder="大最高投注" name="bigmaxtouzhu"><small>同一期大的最高投注，0不限制<br>如：设置1000元，江苏快3 20161220001期大累计投注金额不得超过1000</small>
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($info["smallmaxtouzhu"]); ?>" placeholder="小最高投注" name="smallmaxtouzhu">
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($info["oddmaxtouzhu"]); ?>" placeholder="单最高投注" name="oddmaxtouzhu">
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($info["evenmaxtouzhu"]); ?>" placeholder="单最高投注" name="evenmaxtouzhu">
			</div>
		</div>
        -->
