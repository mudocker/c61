...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal validate-form" id="AjaxPostForm">
        ...
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">充值余额：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
				  <input type="radio" id="state-0" name="state" value="0" <?php if($info['state'] == 0): ?>checked<?php endif; ?>>
				  <label for="type-0">未审核</label>
				</div>
				<div class="radio-box">
				  <input type="radio" id="state-1" name="state" value="1" <?php if($info['state'] == 1): ?>checked<?php endif; ?>>
				  <label for="type-1">审核通过</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="state-2" name="state" value="-1"  <?php if($info['state'] == -1): ?>checked<?php endif; ?>>
