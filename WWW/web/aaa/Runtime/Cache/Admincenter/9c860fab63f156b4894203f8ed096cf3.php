	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
				...
				<th width="80">用户名</th>
	            <th width="80">下注编号</th>
	            <th width="60">DataType</th>
	            <th width="70">TableCode</th>
				...
				<th width="60">下注金额</th>
				<th width="60">有效金额</th>
				<th width="60">RecalcuTime</th>
				<th width="50">NetAmount</th>
		...
		<tbody>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                ...
                <td><?php echo ($vo["AgID"]); ?></td>
               
                <td><?php echo ($vo["PlayerName"]); ?></u></td>
                 <td><?php echo ($vo["BillNo"]); ?></td>
                <td><?php echo ($vo["DataType"]); ?></td>
                <td><?php echo ($vo["TableCode"]); ?></td>
			
				<td><?php echo ($vo["BetTime"]); ?></td>
                <td><?php echo ($vo["GameType"]); ?></td>
				   <td><?php echo ($vo["GameCode"]); ?></td>
             
				<td><?php echo ($vo["BetAmount"]); ?></td>
				<td><?php echo ($vo["ValidBetAmount"]); ?></td>
				<td><?php echo ($vo["RecalcuTime"]); ?></td>

                <td><?php echo ($vo["NetAmount"]); ?></td>
