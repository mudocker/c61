        ...
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                    ...
                    <td><?php echo ($vo['totalcount']?$vo['totalcount']:0); ?></td>
                    <td><?php echo ($vo['agentcount']?$vo['agentcount']:0); ?></td>
                    <td><?php echo ($vo['usercount']?$vo['usercount']:0); ?></td>
                    <td><?php echo ($vo['onlinecount']?$vo['onlinecount']:0); ?></td>
                    <td><?php echo ($vo['zdrecharge']?$vo['zdrecharge']:0); ?></td>
                    <td><?php echo ($vo['sdjiarecharge']?$vo['sdjiarecharge']:0); ?></td>
                    <td><?php echo ($vo['sdjianrecharge']?$vo['sdjianrecharge']:0); ?></td>
                    <td><?php echo ($vo['withdraw']?$vo['withdraw']:0); ?></td>
                    <td><?php echo ($vo['ctyingkui']?$vo['ctyingkui']:0); ?></td>
                    <td><?php echo ($vo['touzhu']?$vo['touzhu']:0); ?></td>
                    <td><?php echo ($vo['zhongjiang']?$vo['zhongjiang']:0); ?></td>
                    <td><?php echo ($vo['huodong']?$vo['huodong']:0); ?></td>
                    <td><?php echo ($vo['tzyingkui']?$vo['tzyingkui']:0); ?></td>
