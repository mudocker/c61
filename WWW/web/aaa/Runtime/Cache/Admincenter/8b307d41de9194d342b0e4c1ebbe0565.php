...
<div class="page-container">
    	...
    	<div class="tabBar cl"><span>用户统计</span><small>&nbsp;&nbsp;&nbsp;&nbsp;投注盈亏 = (投注金额-返奖金额)&nbsp;&nbsp;&nbsp;&nbsp;充提盈亏 = 自动充值+手动加款-手动减款-提款</small></div>
        ...
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tbody>
                ...
                <tr class="text-c warning">
                    <td>页面小计</td>
                    <td><?php echo ($zongji["zdchongzhiall"]); ?></td>
                    <td><?php echo ($zongji["sdjiachongzhiall"]); ?></td>
                    <td><?php echo ($zongji["sdjianchongzhiall"]); ?></td>
                    <td><?php echo ($zongji["tikuanall"]); ?></td>
                     <td><?php echo ($zongji["ctyingkui"]); ?></td>
                   <td><?php echo ($zongji["touzhuall"]); ?></td>
                    <td><?php echo ($zongji["zhongjiangall"]); ?></td>
                    <td><?php echo ($zongji["huodongall"]); ?></td>
                    <td><?php echo ($zongji["tzyingkui"]); ?></td>
                    <td>~~~</td>
                </tr>
            </tbody>
        </table>
