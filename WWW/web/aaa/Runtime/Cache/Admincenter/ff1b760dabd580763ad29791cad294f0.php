...
<table class="table table-border table-bordered table-hover table-bg table-sort">
    <tbody>
        <tr>
            ...
            <td class="text-l"><?php echo ($info["id"]); ?></td>
      </tr>
        <tr>
            <th class="text-r">用户名：</th>
            <td class="text-l"><?php echo ($info["username"]); ?></td>
      </tr>
        <tr>
            <th class="text-r">真实姓名</th>
            <td class="text-l"><?php echo ($info["userbankname"]); ?></td>
      </tr>
        <tr>
            <th class="text-r">手机</th>
            <td class="text-l"><?php echo ($info["tel"]); ?></td>
      </tr>
        <tr>
            <th class="text-r">QQ</th>
            <td class="text-l"><?php echo ($info["qq"]); ?></td>
      </tr>
        <tr>
            <th class="text-r">邮箱</th>
            <td class="text-l"><?php echo ($info["email"]); ?></td>
      </tr>
        <tr>
            <th class="text-r">登陆IP：</th>
            <td class="text-l">
            <?php echo ($info["loginip"]); ?>
            &nbsp;&nbsp;登陆地址：<?php echo ($info["iparea"]); ?>
            </td>
      </tr>
        <tr>
            <th class="text-r">注册IP：</th>
            <td class="text-l">
            <?php echo ($info["regip"]); ?>&nbsp;&nbsp;注册地址：<?php echo (IParea($info["regip"])); ?>
            
            <br>注册时间：<?php if($info['regtime'] != 0): echo (date("Y-m-d H:i",$info["regtime"])); else: ?>~~~<?php endif; ?>
            &nbsp;&nbsp;注册来源：<?php echo ($info["source"]); ?>
            </td>
      </tr>
        <tr>
            <th class="text-r">最后在线时间：</th>
            <td class="text-l"><?php echo (date("Y-m-d H:i",$info["onlinetime"])); ?></td>
      </tr>
        <tr>
            <th class="text-r">会员状态：</th>
            <td class="text-l"><?php if($info['islock'] == 1): ?><span style="color:red">冻结</span><?php else: ?><span style="color:green">正常</span><?php endif; ?></td>
      </tr>
    </tbody>
</table>
</article>
