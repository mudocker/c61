...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal validate-form" id="AjaxPostForm">
        ...
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">晋级会员：</label>
        ...
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">晋级等级：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">奖励金额：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<?php echo ($info["jlje"]); ?> 元
			</div>
		</div>
        
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>晋级状态：</label>
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
				  <input type="radio" id="shenhe-0" name="shenhe" value="0" <?php if($info['shenhe'] == 0): ?>checked<?php endif; ?>>
				  <label for="type-0">未审核</label>
				</div>
				<div class="radio-box">
				  <input type="radio" id="shenhe-1" name="shenhe" value="1" <?php if($info['shenhe'] == 1): ?>checked<?php endif; ?>>
				  <label for="type-1">审核通过</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="shenhe-2" name="shenhe" value="-1"  <?php if($info['shenhe'] == -1): ?>checked<?php endif; ?>>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($info["remark"]); ?>" placeholder="订单备注" name="remark">
			</div>
		</div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-2 col-sm-offset-2">
				<blockquote>
					<small>晋级状态未<span style="color:red">未审核</span>时，才可以操作</small>
