            ...
            <table class="table table-border table-bordered table-hover table-bg table-sort">
                ...
                <tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$table): $mod = ($i % 2 );++$i;?><tr>
                            <td class="num">
                                <input class="ids" <?php if((stripos($table['name'],'_membersession') !== false) || (stripos($table['name'],'_adminsession') !== false)): else: ?>checked="chedked"<?php endif; ?> type="checkbox" name="tables[]" value="<?php echo ($table["name"]); ?>">
                            </td>
                            ...
                            <td class="action">
                                <a class="ajax-get no-refresh" layer-alt-url="<?php echo U('Database/optimize?tables='.$table['name']);?>">优化表</a>&nbsp;
                                <a class="ajax-get no-refresh" layer-alt-url="<?php echo U('Database/repair?tables='.$table['name']);?>">修复表</a>
                            </td>
