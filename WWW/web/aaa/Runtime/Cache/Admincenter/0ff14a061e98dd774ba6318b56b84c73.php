...
<div class="page-container">
    ...
    <?php if(is_array($cptypes)): $i = 0; $__LIST__ = $cptypes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tp): $mod = ($i % 2 );++$i;?><div class="cptypes cl" style="margin-bottom:20px;">
        <div class="tabBar cl"><span><?php echo ($tp["cptype"]); ?></span></div>
        <div class="cplist" style="padding:10px 15px; border:1px solid #ddd; height:1%; overflow:hidden">
            <?php if(is_array($tp['cplist'])): $i = 0; $__LIST__ = $tp['cplist'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="formControls col-xs-6 col-sm-4 col-md-2 skin-minimal radio-box">
                <input name="caijiset[<?php echo ($vo["name"]); ?>]" type="checkbox" value="1" <?php if($caijisets[$vo['name']] == 1): ?>checked<?php endif; ?>><?php echo ($vo["title"]); ?>
