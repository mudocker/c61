...
<article class="page-container">
	<form action="<?php echo U(CONTROLLER_NAME.'/'.ACTION_NAME);?>" method="post" class="form form-horizontal validate-form" id="AjaxPostForm">
        ...
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><?php echo ($passtext); ?>：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="password" class="input-text"  value="" placeholder="<?php echo ($passtext); ?>" name="oldpassword">
			</div>
		</div>
        <?php if($type == 'pass'): ?><div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">新密码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  value="" placeholder="密码" name="password">
			</div>
		</div>
        <?php elseif($type == 'safecode'): ?>
        <div class="row cl">
