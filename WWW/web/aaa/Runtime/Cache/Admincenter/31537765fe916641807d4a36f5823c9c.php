...
<a href="javascript:;" layer-url="<?php echo U('add');?>" title="添加会员组" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加会员组</a>&nbsp;&nbsp;&nbsp;
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
				...
				<td><?php echo ($vo["touhan"]); ?></td>
                <td><u style="cursor:pointer" class="text-primary" layer-url="<?php echo U('setxiane',['id'=>$vo['groupid']]);?>" title="限额设置-<?php echo ($vo["groupname"]); ?>">限额设置</u></td>
				<td class="td-manage">
