    ...
    <div class="mt-5">
        <form method="post" action="<?php echo U(CONTROLLER_NAME.'/'.ACTION_NAME);?>">
            <table class="table table-border table-bordered table-hover table-bg table-sort">
                ...
                <tbody>
                <?php if(is_array($fanshui)): $i = 0; $__LIST__ = $fanshui;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                    <td width="80"><?php echo ($vo["uid"]); ?></td>
                    <td width="80"><?php echo ($vo["username"]); ?></td>
                    <td width="60"><?php echo ($vo["yongjinfw"]); ?></td>
                    <td width="60"><?php echo ($vo["bili"]); ?></td>
                    <td width="60"><?php echo ($vo["touzhuedu"]); ?></td>
                    <td width="60"><?php echo ($vo["amount"]); ?>元</td>
                    <td width="60"><?php echo (date('Y-m-d',$vo["oddtime"])); ?></td>
                    <td width="30">
                        <?php if($vo['shenhe'] == 0): ?><u style="cursor:pointer;color:red" class="text-primary" layer-url="<?php echo U('fanshuishenhe',['id'=>$vo['id']]);?>" title="会员反水审核">未审核</u>
