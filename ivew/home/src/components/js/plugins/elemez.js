export default {
    install(Vue,options)
    {
        ...
        /*<einput  :result.sync="other.duration" title="窗口自动关闭时间" type="medium"/>*/
        Vue.component('einput',{
            template: '<el-col :span="span" :offset="offset"><el-input style="width: 250px;" v-model="value" :size="size">' +
            ...
            watch:{
                value(val){ this.$emit('update:result', val); },
            }
        });
